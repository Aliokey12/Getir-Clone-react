...
export default function header() {
  return (
    ...
    <nav className="flex gap-x-8 text-sm font-semibold">
      ...
      <a id="kayıt-ol" href="" className=" flex items-center gap-x-2 text-white transition-all  text-opacity-80 hover:text-opacity-100"> 
